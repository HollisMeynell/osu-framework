...
export default function HelloBox({title}: HelloBoxProps) {
    return <div className={clsx(styles.box)}>
        <div className={clsx(styles.main, "container")}>
            ...
            <p>一个 osu辅助类应用网站</p>
            <div>
                <Link to={"/d/web/"} className={clsx("button button--primary button--lg")}>
                    开始使用
                </Link>
                <Link to={"/d/api/"} className={clsx("button button--primary button--lg")}>
                    查看API文档
                </Link>
                <Link to={"/d/dev/"} className={clsx("button button--primary button--lg")}>
                    查看后端文档
                </Link>
